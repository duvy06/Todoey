...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // added from a dummy project with coredata checked
    // just in case this project was not initiate with coredata
    // also include in new file for coredata feature see: DataModel.xcdatamodeld in Data Model
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        // replace the name 'CoreData' with our model 'DataModel'
